...
function displayPics() {
 ...
 // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the letiable declaration from `let to `let`.
  // When you want to declare a variable using let, you should declare it in a block {}, and it will not be declared out of that block, so if you call that variable out of the block it will not be defiened.
